...
void convert_num(int arg_current_base, int arg_final_base,
                 const char* arg_current_num, std::string& arg_converted_num) {
    ...
    if(is_float) {
        ...
        if(arg_current_num[0] == '-') arg_converted_num = '-' + arg_converted_num;
    }
}
